...
| **agate** | 3.3.21 | Very simple server for the Gemini hypertext protocol | https://github.com/mbrubeck/agate |
...
| **aspnetcore-runtime-10.0** | 10.0.5 | ASP.NET Core 10.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-runtime-8.0** | 8.0.25 | ASP.NET Core 8.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-runtime-9.0** | 9.0.14 | ASP.NET Core 9.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-runtime-dbg-10.0** | 10.0.5 | ASP.NET Core 10.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-runtime-dbg-8.0** | 8.0.25 | ASP.NET Core 8.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-runtime-dbg-9.0** | 9.0.14 | ASP.NET Core 9.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-targeting-pack-10.0** | 10.0.5 | ASP.NET Core 10.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-targeting-pack-8.0** | 8.0.25 | ASP.NET Core 8.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-targeting-pack-9.0** | 9.0.14 | ASP.NET Core 9.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
...
| **blas-openblas** | 0.3.32 | OpenBLAS symlinks for BLAS/CBLAS/LAPACK/LAPACKE | https://www.openblas.net |
...
| **ccache** | 4.13.2 | Compiler cache for fast recompilation of C/C++ code | https://ccache.samba.org |
...
| **clvk** | 0.0.20260331.162111 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
| **cmake** | 4.3.1 | Family of tools designed to build, test and package software | https://cmake.org/ |
| **cmake-curses-gui** | 4.3.1 | Curses based user interface for CMake (ccmake) | https://cmake.org/ |
...
| **codon** | 0.19.5 | A high-performance, zero-overhead, extensible Python compiler using LLVM | https://github.com/exaloop/codon |
...
| **command-not-found** | 3.4.1-4 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **cookcli** | 0.28.1 | A suite of tools to create shopping lists and maintain food recipes | https://cooklang.org |
...
| **cups** | 2.4.16-1 | Common UNIX Printing System | https://www.cups.org/ |
| **cups-pdf** | 3.0.1-3 | CUPS PDF backend | https://www.cups-pdf.de/ |
| **cups-static** | 2.4.16-1 | Static libraries for cups | https://www.cups.org/ |
...
| **dart** | 3.11.4 | Dart is a general-purpose programming language | https://dart.dev/ |
| **dasel** | 3.4.1 | Select, put and delete data from JSON, TOML, YAML, XML and CSV files with a single utility | https://github.com/TomWright/dasel |
...
| **dotnet-apphost-pack-10.0** | 10.0.5 | .NET 10.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-apphost-pack-8.0** | 8.0.25 | .NET 8.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-apphost-pack-9.0** | 9.0.14 | .NET 9.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-host** | 10.0 | A metapackage for .NET Host | https://dotnet.microsoft.com/en-us/ |
| **dotnet-host-10.0** | 10.0.5 | .NET 10.0 Host | https://dotnet.microsoft.com/en-us/ |
| **dotnet-host-8.0** | 8.0.25 | .NET 8.0 Host | https://dotnet.microsoft.com/en-us/ |
| **dotnet-host-9.0** | 9.0.14 | .NET 9.0 Host | https://dotnet.microsoft.com/en-us/ |
| **dotnet-hostfxr-10.0** | 10.0.5 | .NET 10.0 Host Resolver | https://dotnet.microsoft.com/en-us/ |
| **dotnet-hostfxr-8.0** | 8.0.25 | .NET 8.0 Host Resolver | https://dotnet.microsoft.com/en-us/ |
| **dotnet-hostfxr-9.0** | 9.0.14 | .NET 9.0 Host Resolver | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-10.0** | 10.0.5 | .NET 10.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-8.0** | 8.0.25 | .NET 8.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-9.0** | 9.0.14 | .NET 9.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-dbg-10.0** | 10.0.5 | .NET 10.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-dbg-8.0** | 8.0.25 | .NET 8.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-dbg-9.0** | 9.0.14 | .NET 9.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-10.0** | 10.0.5 | .NET 10.0 SDK | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-8.0** | 8.0.25 | .NET 8.0 SDK | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-9.0** | 9.0.14 | .NET 9.0 SDK | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-dbg-10.0** | 10.0.5 | .NET 10.0 SDK Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-dbg-8.0** | 8.0.25 | .NET 8.0 SDK Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-dbg-9.0** | 9.0.14 | .NET 9.0 SDK Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-targeting-pack-10.0** | 10.0.5 | .NET 10.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-targeting-pack-8.0** | 8.0.25 | .NET 8.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-targeting-pack-9.0** | 9.0.14 | .NET 9.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-templates-10.0** | 10.0.5 | .NET 10.0 Templates | https://dotnet.microsoft.com/en-us/ |
| **dotnet-templates-8.0** | 8.0.25 | .NET 8.0 Templates | https://dotnet.microsoft.com/en-us/ |
| **dotnet-templates-9.0** | 9.0.14 | .NET 9.0 Templates | https://dotnet.microsoft.com/en-us/ |
| **dotnet10.0** | 10.0.5 | .NET 10.0 | https://dotnet.microsoft.com/en-us/ |
| **dotnet8.0** | 8.0.25 | .NET 8.0 | https://dotnet.microsoft.com/en-us/ |
| **dotnet9.0** | 9.0.14 | .NET 9.0 | https://dotnet.microsoft.com/en-us/ |
...
| **duckdb** | 1.5.1 | DuckDB Command Line Interface (CLI) shell | https://duckdb.org/ |
...
| **e2fsprogs** | 1.47.4 | EXT 2/3/4 filesystem utilities | https://e2fsprogs.sourceforge.net |
...
| **electrum** | 4.7.1 | Electrum is a lightweight Bitcoin wallet | https://electrum.org |
...
| **emacs** | 30.2-1 | Extensible, customizable text editor-and more | https://www.gnu.org/software/emacs/ |
| **emmylua-ls** | 0.22.0 | Emmy Lua Language Server coded in Rust | https://github.com/EmmyLuaLs/emmylua-analyzer-rust |
| **emscripten** | 5.0.5 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 5.0.5 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 5.0.5 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 5.0.5 | Emscripten third party test suite files | https://emscripten.org |
...
| **exiftool** | 13.55 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **fastfetch** | 2.61.0 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **faust-static** | 2.85.5 | Static libraries for faust | https://github.com/grame-cncm/faust |
...
| **forgejo** | 14.0.3 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **fresh-editor** | 0.2.22 | Text editor for your terminal: easy, powerful and fast | https://getfresh.dev/ |
...
| **fzf** | 0.71.0 | Command-line fuzzy finder | https://junegunn.github.io/fzf/ |
...
| **gdal** | 3.12.3-1 | A translator library for raster and vector geospatial data formats | https://gdal.org |
| **gdb** | 16.3-3 | The standard GNU Debugger that runs on many Unix-like systems and works for many programming languages | https://www.gnu.org/software/gdb/ |
...
| **gdu** | 5.34.4 | Fast disk usage analyzer with console interface written in Go | https://github.com/dundee/gdu |
...
| **geth** | 1.17.2 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.17.2 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **gh** | 2.89.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **git** | 2.53.0 | Fast, scalable, distributed revision control system | https://git-scm.com/ |
...
| **git-gitk** | 2.53.0 | Git repository browser | https://git-scm.com/ |
| **git-gui** | 2.53.0 | A graphical interface to Git | https://git-scm.com/ |
...
| **git-svn** | 2.53.0 | Convert between Git and Subversion repositories | https://git-scm.com/ |
...
| **go-musicfox** | 4.8.1 | A netease music player in terminal. | https://github.com/go-musicfox/go-musicfox |
...
| **golang** | 3:1.26.1 | Go programming language compiler | https://go.dev/ |
| **golang-doc** | 3:1.26.1 | Go programming language - documentation | https://go.dev/ |
...
| **gomuks** | 26.03 | A terminal Matrix client written in Go | https://go.mau.fi/gomuks |
...
| **goose** | 3.27.0 | A database migration tool. Supports SQL migrations and Go functions. | https://pressly.github.io/goose |
...
| **goresym** | 3.3 | Go symbol recovery tool | https://github.com/mandiant/GoReSym |
...
| **gradle** | 1:9.4.1 | Powerful build system for the JVM | https://gradle.org/ |
...
| **graphicsmagick-static** | 1.3.46 | Static libraries for graphicsmagick | http://www.graphicsmagick.org/ |
| **graphviz** | 14.1.4 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 14.1.4 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **groonga** | 16.0.1 | An embeddable fulltext search engine | https://github.com/groonga/groonga/ |
...
| **hcloud** | 1.62.2 | Hetzner Cloud command line client | https://github.com/hetznercloud/cli |
...
| **hexyl** | 0.17.0 | A command-line hex viewer | https://github.com/sharkdp/hexyl |
...
| **hledger** | 1.43.2-1 | Robust, friendly, fast plain text accounting software. (CLI only) | https://hledger.org/ |
| **hledger-ui** | 1.43.2 | hledger-ui - terminal interface (TUI) for hledger, a robust, friendly plain text accounting app. | https://hledger.org/ |
...
| **htop** | 3.5.0 | Interactive process viewer for Linux | https://htop.dev/ |
...
| **hugo** | 0.160.1 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **i2pd** | 2.59.0 | A full-featured C++ implementation of the I2P router | https://i2pd.website/ |
| **i2pd-static** | 2.59.0 | Static libraries for i2pd | https://i2pd.website/ |
...
| **icon-naming-utils** | 0.8.90 | Maps the new names of icons for Tango to the legacy names used by the GNOME and KDE desktops | http://tango.freedesktop.org/ |
...
| **icu-devtools** | 78.3 | Development utilities for International Components for Unicode | http://site.icu-project.org/home |
...
| **imagemagick** | 7.1.2.18-1 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.2.18-1 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **inxi** | 3.3.40-1-0 | Full featured CLI system information tool | https://smxi.org/site/about.htm#inxi |
...
| **jackett** | 0.24.1554 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jfrog-cli** | 2.99.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **just** | 1.49.0 | A handy way to save and run project-specific commands | https://just.systems |
...
| **kotlin** | 2.3.20 | The Kotlin Programming Language | https://kotlinlang.org/ |
...
| **kubectl** | 1.35.3 | Kubernetes.io client binary | https://kubernetes.io/ |
...
| **lego** | 4.33.0 | Let's Encrypt/ACME client and library written in Go | https://github.com/go-acme/lego |
...
| **lfortran** | 0.61.0 | A modern open-source interactive Fortran compiler | https://lfortran.org/ |
| **lfortran-static** | 0.61.0 | Static libraries for lfortran | https://lfortran.org/ |
...
| **libandroid-posix-semaphore-static** | 0.1-4 | Static libraries for libandroid-posix-semaphore | https://man7.org/linux/man-pages/man7/sem_overview.7.html |
| **libandroid-selinux** | 14.0.0.11-1 | Android fork of libselinux, an SELinux userland library | https://selinuxproject.org |
| **libandroid-shmem** | 0.7 | System V shared memory emulation on Android using ashmem | https://github.com/termux/libandroid-shmem |
...
| **libbs2b** | 3.1.0-2 | Bauer stereophonic-to-binaural DSP | https://bs2b.sourceforge.net/ |
...
| **libburn** | 1.5.6-1 | Library for reading, mastering and writing optical discs | https://dev.lovelyhq.com/libburnia |
...
| **libcaca-static** | 0.99.beta20-3 | Static libraries for libcaca | http://caca.zoy.org/wiki/libcaca |
| **libcairo** | 1.18.4-2 | Cairo 2D vector graphics library | https://cairographics.org |
| **libcairomm-1.0** | 1.14.5-1 | Provides a C++ interface to cairo | https://www.cairographics.org/cairomm/ |
| **libcairomm-1.16** | 1.18.0-1 | Provides a C++ interface to cairo | https://www.cairographics.org/cairomm/ |
...
| **libcoinor-osi-static** | 1:0.108.8-1 | Static libraries for libcoinor-osi | https://github.com/coin-or/Osi |
...
| **libconfuse-static** | 3.3-1 | Static libraries for libconfuse | https://github.com/martinh/libconfuse |
| **libcpufeatures** | 0.10.1-1 | A cross-platform C library to retrieve CPU features (such as available instructions) at runtime | https://github.com/google/cpu_features |
| **libcroco** | 0.6.13-10 | CSS parsing and manipulation library | https://gitlab.gnome.org/Archive/libcroco |
| **libcroco-static** | 0.6.13-10 | Static libraries for libcroco | https://gitlab.gnome.org/Archive/libcroco |
| **libcrypt** | 0.2-6 | A crypt(3) implementation | http://michael.dipperstein.com/crypt/ |
| **libcue** | 2.3.0-1 | CUE Sheet Parser Library | https://github.com/lipnitsk/libcue/ |
| **libcunit** | 2.1.3-1 | C Unit Testing Framework | https://sourceforge.net/projects/cunit/ |
| **libcunit-static** | 2.1.3-1 | Static libraries for libcunit | https://sourceforge.net/projects/cunit/ |
| **libcurl** | 8.19.0 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.19.0 | Static libraries for libcurl | https://curl.se/ |
| **libczmq** | 4.2.1-4 | High-level C binding for ZeroMQ | https://zeromq.org/ |
...
| **libdart** | 6.16.7 | Dynamic Animation and Robotics Toolkit | https://dartsim.github.io/ |
...
| **libduckdb** | 1.5.1 | An in-process SQL OLAP database management system | https://duckdb.org/ |
| **libduckdb-static** | 1.5.1 | Static libraries for libduckdb | https://duckdb.org/ |
...
| **libdvbpsi** | 1.3.3-1 | Simple MPEG TS PSI parser library supporting various standards | https://code.videolan.org/videolan/libdvbpsi/ |
| **libdvbpsi-static** | 1.3.3-1 | Static libraries for libdvbpsi | https://code.videolan.org/videolan/libdvbpsi/ |
| **libdvdnav** | 7.0.0 | A library that allows easy use of sophisticated DVD navigation features | https://www.videolan.org/developers/libdvdnav.html |
| **libdvdnav-static** | 7.0.0 | Static libraries for libdvdnav | https://www.videolan.org/developers/libdvdnav.html |
| **libdvdread** | 7.0.1 | A library that allows easy use of sophisticated DVD navigation features | https://code.videolan.org/videolan/libdvdread |
| **libdvdread-static** | 7.0.1 | Static libraries for libdvdread | https://code.videolan.org/videolan/libdvdread |
| **libdw** | 0.193-1 | Library to read DWARF information | https://sourceware.org/elfutils/ |
| **libdw-static** | 0.193-1 | Static library to read DWARF information | https://sourceware.org/elfutils/ |
| **libebml** | 1.4.5-2 | Extensible Binary Meta Language library | https://github.com/Matroska-Org/libebml |
...
| **libelf** | 0.193-1 | ELF object file access library | https://sourceware.org/elfutils/ |
...
| **libev-static** | 4.33-2 | Static libraries for libev | http://software.schmorp.de/pkg/libev.html |
...
| **libexpat** | 2.7.5 | XML parsing C library | https://libexpat.github.io/ |
| **libexpat-static** | 2.7.5 | Static libraries for libexpat | https://libexpat.github.io/ |
...
| **libfdisk** | 2.41.3 | Library for manipulating disk partition tables | https://en.wikipedia.org/wiki/Util-linux |
...
| **libffi-static** | 3.4.7-1 | Static libraries for libffi | https://sourceware.org/libffi/ |
| **libfixposix** | 0.5.1-1 | Thin wrapper over POSIX syscalls | https://github.com/sionescu/libfixposix/ |
| **libfixposix-static** | 0.5.1-1 | Static libraries for libfixposix | https://github.com/sionescu/libfixposix/ |
| **libflac** | 1.5.0-1 | FLAC (Free Lossless Audio Codec) library | https://xiph.org/flac/ |
...
| **libfyaml** | 0.9.6-1 | Fully feature complete YAML parser and emitter | https://pantoniou.github.io/libfyaml/ |
...
| **libgeotiff** | 1.7.4-2 | Library for handling TIFF for georeferenced raster imagery | https://github.com/OSGeo/libgeotiff |
| **libgf2x** | 1.3.0-2 | A library for multiplying polynomials over the binary field | https://gitlab.inria.fr/gf2x/gf2x |
| **libgf2x-static** | 1.3.0-2 | Static libraries for libgf2x | https://gitlab.inria.fr/gf2x/gf2x |
...
| **libgit2** | 1.9.2 | C library implementing Git core methods | https://libgit2.github.com/ |
...
| **libgmime-static** | 3.2.15-2 | Static libraries for libgmime | https://github.com/jstedfast/gmime |
...
| **libgts-static** | 0.7.6-3 | Static libraries for libgts | https://gts.sourceforge.net/ |
| **libgxps** | 0.3.2-3 | handling and rendering XPS documents | https://wiki.gnome.org/libgxps |
| **libhangul** | 0.2.0-1 | A library to support hangul input method logic | https://github.com/libhangul/libhangul |
| **libhangul-static** | 0.2.0-1 | Static libraries for libhangul | https://github.com/libhangul/libhangul |
...
| **libhyphen** | 2.8.8-1 | hyphenation library to use converted TeX hyphenation patterns | https://github.com/hunspell/hyphen |
| **libhyphen-static** | 2.8.8-1 | Static libraries for libhyphen | https://github.com/hunspell/hyphen |
| **libical** | 3.0.20-3 | Libical is an Open Source implementation of the iCalendar protocols and protocol data units | https://libical.github.io/libical/ |
| **libice** | 1.1.2-1 | X11 Inter-Client Exchange library | https://xorg.freedesktop.org/ |
| **libiconv** | 1.18-1 | An implementation of iconv() | https://www.gnu.org/software/libiconv/ |
...
| **libidn2-static** | 2.3.8-1 | Static libraries for libidn2 | https://www.gnu.org/software/libidn/#libidn2 |
| **libigloo** | 0.9.5 | Generic C framework used and developed by the Icecast project | https://icecast.org |
| **libigloo-static** | 0.9.5 | Static libraries for libigloo | https://icecast.org |
...
| **libimobiledevice** | 1.3.0-p20250228-3 | A library to communicate with services on iOS devices using native protocols | https://libimobiledevice.org/ |
...
| **libimobiledevice-static** | 1.3.0-p20250228-3 | Static libraries for libimobiledevice | https://libimobiledevice.org/ |
...
| **libiniparser** | 4.2.6-2 | Offers parsing of ini files from the C level | https://github.com/ndevilla/iniparser |
...
| **libisoburn** | 1.5.6-1 | Frontend for libraries libburn and libisofs | https://dev.lovelyhq.com/libburnia |
...
| **libjansson** | 2.15.0 | C library for encoding, decoding and manipulating JSON data | http://www.digip.org/jansson/ |
...
| **libjpeg-turbo** | 3.1.4.1 | Library for reading and writing JPEG image files | https://libjpeg-turbo.virtualgl.org |
| **libjpeg-turbo-progs** | 3.1.4.1 | Programs for manipulating JPEG files | https://libjpeg-turbo.virtualgl.org |
| **libjpeg-turbo-static** | 3.1.4.1 | Static libraries for libjpeg-turbo | https://libjpeg-turbo.virtualgl.org |
...
| **libkokkos** | 5.1.0 | Implements a programming model in C++ for writing performance portable applications | https://github.com/kokkos |
| **libkokkos-static** | 5.1.0 | Static libraries for libkokkos | https://github.com/kokkos |
...
| **libksba-static** | 1.6.8 | Static libraries for libksba | https://gnupg.org/related_software/libksba/ |
...
| **liblog4cxx** | 1.7.0 | A logging framework for C++ patterned after Apache log4j | https://logging.apache.org/log4cxx/latest_stable/index.html |
...
| **libmosquitto** | 2.1.2 | MQTT library | https://mosquitto.org/ |
| **libmount** | 2.41.3 | Library for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **libmpc** | 1.3.1-1 | Library for the arithmetic of complex numbers with arbitrarily high precision | https://www.multiprecision.org/ |
| **libmpc-static** | 1.3.1-1 | Static libraries for libmpc | https://www.multiprecision.org/ |
| **libmpdclient** | 2.24 | Asynchronous API library for interfacing MPD in the C, C++ & Objective C languages | https://www.musicpd.org/libs/libmpdclient/ |
| **libmpeg2** | 0.5.1-2 | MPEG-2 decoder libraries | https://libmpeg2.sourceforge.io/ |
| **libmpeg2-static** | 0.5.1-2 | Static libraries for libmpeg2 | https://libmpeg2.sourceforge.io/ |
| **libmpfr** | 4.2.1-1 | C library for multiple-precision floating-point computations with correct rounding | https://www.mpfr.org/ |
| **libmpfr-static** | 4.2.1-1 | Static libraries for libmpfr | https://www.mpfr.org/ |
| **libmpg123** | 1.33.3 | Fast console MPEG Audio Player and decoder library | https://mpg123.org/ |
| **libmpg123-static** | 1.33.3 | Static libraries for libmpg123 | https://mpg123.org/ |
| **libmsgpack** | 6.1.0-1 | MessagePack implementation for C | https://github.com/msgpack/msgpack-c/ |
| **libmsgpack-cxx** | 7.0.0-4 | msgpack for C++ | https://msgpack.org/ |
| **libmsgpack-static** | 6.1.0-1 | Static libraries for libmsgpack | https://github.com/msgpack/msgpack-c/ |
...
| **libnettle** | 4.0+really3.10.2 | Cryptographic library that is designed to fit easily in more or less any context | https://www.lysator.liu.se/~nisse/nettle/ |
| **libnettle-static** | 4.0+really3.10.2 | Static libraries for libnettle | https://www.lysator.liu.se/~nisse/nettle/ |
...
| **libngtcp2** | 1.22.0 | Implementation of IETF QUIC protocol | https://github.com/ngtcp2/ngtcp2 |
| **libngtcp2-static** | 1.22.0 | Static libraries for libngtcp2 | https://github.com/ngtcp2/ngtcp2 |
...
| **libnova** | 0.16-1 | A general purpose, double precision, Celestial Mechanics, Astrometry and Astrodynamics library | https://libnova.sourceforge.net |
...
| **libodfgen** | 0.1.8-4 | Library for generating documents in Open Document Format | https://sourceforge.net/p/libwpd/wiki/libodfgen/ |
| **libodfgen-static** | 0.1.8-4 | Static libraries for libodfgen | https://sourceforge.net/p/libwpd/wiki/libodfgen/ |
...
| **libosmium** | 2.23.1 | Library for reading from and writing to OSM files in XML and PBF formats | https://osmcode.org/libosmium/ |
| **libosmpbf** | 1.5.1-3 | osmpbf is a Java/C library to read and write OpenStreetMap PBF files | https://github.com/openstreetmap/OSM-binary/ |
| **libosmpbf-static** | 1.5.1-3 | Static libraries for libosmpbf | https://github.com/openstreetmap/OSM-binary/ |
| **libotr** | 4.1.1-3 | Off-the-Record (OTR) Messaging allows you to have private conversations over instant messaging by providing: Encryption, Authentication, Deniability, Perfect forward secrecy | https://otr.cypherpunks.ca |
| **libotr-static** | 4.1.1-3 | Static libraries for libotr | https://otr.cypherpunks.ca |
...
| **libp8-platform** | 2.1.0.1-4 | Platform support library used by libCEC and binary add-ons for Kodi | https://github.com/Pulse-Eight/platform |
| **libpagmo** | 2.19.1-5 | Scientific library for massively parallel optimization | https://esa.github.io/pagmo2/index.html |
...
| **libpano13** | 2.9.23-1 | Part of the Panorama Tools by Helmut Dersch | https://panotools.sourceforge.net/ |
| **libpano13-static** | 2.9.23-1 | Static libraries for libpano13 | https://panotools.sourceforge.net/ |
| **libpaper** | 2.2.7 | Library for handling paper characteristics (by @rrthomas) | https://github.com/rrthomas/psutils |
| **libpaper-static** | 2.2.7 | Static libraries for libpaper | https://github.com/rrthomas/psutils |
...
| **libpixman** | 0.46.4-1 | Low-level library for pixel manipulation | https://www.pixman.org/ |
| **libplacebo** | 7.360.1 | Reusable library for GPU-accelerated video/image rendering | http://libplacebo.org/ |
...
| **libprotobuf-c** | 1.5.2-3 | Protocol buffers C library | https://github.com/protobuf-c/protobuf-c |
| **libprotobuf-c-static** | 1.5.2-3 | Static libraries for libprotobuf-c | https://github.com/protobuf-c/protobuf-c |
...
| **librsvg** | 2.62.1 | Library to render SVG files using cairo | https://wiki.gnome.org/action/show/Projects/LibRsvg |
...
| **libshout-static** | 2.4.6-2 | Static libraries for libshout | https://icecast.org/ |
...
| **libsmartcols** | 2.41.3 | Library for smart adaptive formatting of tabular data | https://en.wikipedia.org/wiki/Util-linux |
...
| **libspatialite-static** | 5.1.0-3 | Static libraries for libspatialite | https://www.gaia-gis.it/fossil/libspatialite |
| **libspdlog** | 1.17.0 | Very fast, header-only/compiled, C++ logging library | https://github.com/gabime/spdlog |
| **libspectre** | 0.2.12-3 | A small library for rendering Postscript documents | https://www.freedesktop.org/wiki/Software/libspectre/ |
| **libspectre-static** | 0.2.12-3 | Static libraries for libspectre | https://www.freedesktop.org/wiki/Software/libspectre/ |
| **libspeex** | 1.2.1-1 | A patent-free, Open Source/Free Software voice codec | https://www.speex.org/ |
| **libspeex-static** | 1.2.1-1 | Static libraries for libspeex | https://www.speex.org/ |
...
| **libt3highlight** | 0.5.0-2 | A library for syntax highlighting different types of text files | https://os.ghalkes.nl/t3/libt3highlight.html |
| **libt3key** | 0.2.11-1 | A library and database with escape sequence to key symbol mappings | https://os.ghalkes.nl/t3/libt3key.html |
| **libt3widget** | 1.2.2-3 | A library of widgets and dialogs to facilitate construction of easy-to-use terminal-based programs | https://os.ghalkes.nl/t3/libt3widget.html |
...
| **libtermkey** | 0.22-5 | Library for processing of keyboard entry for terminal-based programs | http://www.leonerd.org.uk/code/libtermkey/ |
...
| **libtiledb** | 2.30.1 | A powerful engine for storing and accessing dense and sparse multi-dimensional arrays | https://tiledb.com/ |
| **libtins** | 4.5-4 | High-level, multiplatform C++ network packet sniffing and crafting library. | https://libtins.github.io |
...
| **libtsduck** | 3.43.4549-1 | An extensible toolkit for MPEG transport streams | https://tsduck.io/ |
| **libtsduck-static** | 3.43.4549-1 | Static libraries for libtsduck | https://tsduck.io/ |
...
| **libucontext** | 1.5 | A library which provides the ucontext.h C API | https://github.com/kaniini/libucontext |
...
| **libuuid** | 2.41.3 | Library for handling universally unique identifiers | https://en.wikipedia.org/wiki/Util-linux |
| **libuv** | 1.52.1 | Support library with a focus on asynchronous I/O | https://libuv.org |
| **libuv-static** | 1.52.1 | Static libraries for libuv | https://libuv.org |
...
| **libvips** | 8.18.2 | A fast image processing library with low memory needs | https://libvips.github.io/libvips/ |
...
| **libvmaf** | 3.1.0-1 | A perceptual video quality assessment algorithm developed by Netflix | https://github.com/Netflix/vmaf |
| **libvmaf-static** | 3.1.0-1 | Static libraries for libvmaf | https://github.com/Netflix/vmaf |
...
| **libwps** | 0.4.14-2 | a Microsoft Works file word processor format import filter library | https://sourceforge.net/projects/libwps/ |
...
| **libwv** | 1.2.9-6 | A library which allows access to Microsoft Word files | https://wvware.sourceforge.net/ |
| **libwv-static** | 1.2.9-6 | Static libraries for libwv | https://wvware.sourceforge.net/ |
| **libx11** | 1.8.13 | X11 client-side library | https://xorg.freedesktop.org/ |
...
| **libxdmcp-static** | 1.1.5-2 | Static libraries for libxdmcp | https://xorg.freedesktop.org/ |
| **libxdrfile** | 1.1.4-2 | Library for reading and writing xtc, edr and trr files | https://userguide.mdanalysis.org/stable/formats/reference/xtc.html |
| **libxext** | 1.3.7 | X11 miscellaneous extensions library | https://xorg.freedesktop.org/ |
| **libxext-static** | 1.3.7 | Static libraries for libxext | https://xorg.freedesktop.org/ |
| **libxfixes** | 6.0.2 | X11 miscellaneous 'fixes' extension library | https://xorg.freedesktop.org/ |
| **libxfixes-static** | 6.0.2 | Static libraries for libxfixes | https://xorg.freedesktop.org/ |
| **libxft** | 2.3.9-1 | FreeType-based font drawing library for X | https://xorg.freedesktop.org/ |
| **libxft-static** | 2.3.9-1 | Static libraries for libxft | https://xorg.freedesktop.org/ |
| **libxi** | 1.8.2-1 | X11 Input extension library | https://xorg.freedesktop.org/ |
| **libxi-static** | 1.8.2-1 | Static libraries for libxi | https://xorg.freedesktop.org/ |
| **libxls** | 1.6.3-2 | A C library for reading Excel files in the nasty old binary OLE format | https://github.com/libxls/libxls |
...
| **libxml2** | 2.15.2-2 | Library for parsing XML documents | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
| **libxml2-python** | 2.15.2-2 | Python bindings for libxml2 | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
| **libxml2-utils** | 2.15.2-2 | XML utilities | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
...
| **libxshmfence** | 1.3.3-1 | A library that exposes a event API on top of Linux futexes | https://xorg.freedesktop.org/ |
| **libxslt** | 1.1.45-1 | XSLT processing library | http://xmlsoft.org/libxslt/ |
...
| **libxt** | 1.3.1-1 | X11 toolkit intrinsics library | https://xorg.freedesktop.org/ |
| **libxt-static** | 1.3.1-1 | Static libraries for libxt | https://xorg.freedesktop.org/ |
...
| **lilypond** | 2.24.4-6 | A music engraving program | https://lilypond.org/ |
...
| **litespeedtest** | 0.15.0-3 | A simple tool for batch test ss/ssr/v2ray/trojan servers | https://github.com/xxf098/LiteSpeedTest |
| **littlecms** | 2.18 | Color management library | http://www.littlecms.com/ |
...
| **llama-cpp** | 0.0.0-b8580-0 | LLM inference in C/C++ | https://github.com/ggml-org/llama.cpp |
| **llama-cpp-backend-opencl** | 0.0.0-b8580-0 | OpenCL Backend for LLaMA.cpp | https://github.com/ggml-org/llama.cpp |
| **llama-cpp-backend-vulkan** | 0.0.0-b8580-0 | Vulkan Backend for LLaMA.cpp | https://github.com/ggml-org/llama.cpp |
...
| **locustdb** | 0.4.6-2 | An experimental analytics database | https://github.com/cswinter/LocustDB |
...
| **luajit** | 1:2.1.1774896198+g18b087c | Just-In-Time Compiler for Lua | https://luajit.org/ |
...
| **luajit-static** | 1:2.1.1774896198+g18b087c | Static libraries for luajit | https://luajit.org/ |
| **luarocks** | 3.13.0-1 | Deployment and management system for Lua modules | https://luarocks.org/ |
| **lunasvg** | 3.5.0 | SVG rendering and manipulation library in C++ | https://github.com/sammycage/lunasvg |
...
| **lux-cli** | 0.28.0 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **lzip** | 1.26 | Lossless data compressor similar to gzip and bzip2 | https://www.nongnu.org/lzip/ |
...
| **manim** | 0.20.1-2 | A community-maintained Python framework for creating mathematical animations | https://manim.community |
| **manpages** | 6.17 | Man pages for linux kernel and C library interfaces | https://www.kernel.org/doc/man-pages/ |
...
| **mariadb** | 2:12.2.2 | A drop-in replacement for mysql server | https://mariadb.org |
| **mariadb-static** | 2:12.2.2 | Static libraries for mariadb | https://mariadb.org |
...
| **matplotlib** | 3.10.8-3 | A comprehensive library for creating static, animated, and interactive visualizations in Python | https://matplotlib.org/ |
...
| **mautrix-whatsapp** | 0.2603.0 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
| **maven** | 3.9.14 | A Java software project management and comprehension tool | https://maven.apache.org/ |
...
| **mbedtls** | 3.6.4-1 | Light-weight cryptographic and SSL/TLS library | https://www.trustedfirmware.org/projects/mbed-tls/ |
...
| **mdbook** | 0.5.2 | Creates book from markdown files | https://rust-lang.github.io/mdBook/ |
...
| **mdbook-open-on-gh** | 3.0.0 | A preprocessor for mdbook to add a open-on-github link on every page | https://github.com/badboy/mdbook-open-on-gh |
...
| **mediamtx** | 1.17.1 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
| **megacmd** | 2.5.1 | Provides non UI access to MEGA services | https://mega.io/ |
...
| **miller** | 6.17.0 | Like awk, sed, cut, join, and sort for name-indexed data such as CSV, TSV, and tabular JSON | https://miller.readthedocs.io/ |
...
| **minizinc** | 2.9.5 | A medium-level constraint modelling language | https://github.com/MiniZinc/libminizinc |
| **minizinc-static** | 2.9.5 | Static libraries for minizinc | https://github.com/MiniZinc/libminizinc |
...
| **moor** | 2.12.0 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **mosquitto** | 2.1.2 | MQTT version 3.1/3.1.1 compatible message broker and clients | https://mosquitto.org/ |
| **most** | 5.2.0-3 | A terminal pager similar to 'more' and 'less' | http://www.jedsoft.org/most/index.html |
| **mount-utils** | 2.41.3 | Utilities for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **mpd** | 0.24.9 | Music player daemon | https://www.musicpd.org |
...
| **mujs** | 1.3.9 | A lightweight Javascript interpreter designed for embedding in other software | https://mujs.com/ |
| **mujs-static** | 1.3.9 | Static libraries for mujs | https://mujs.com/ |
...
| **mutt** | 2.3.1 | Mail client with patches from neomutt | http://www.mutt.org/ |
...
| **navidrome** | 0.61.0 | Modern Music Server and Streamer compatible with Subsonic/Airsonic | https://www.navidrome.org/ |
...
| **ncurses-ui-libs-static** | 6.6.20260307+really6.5.20250830 | Static libraries for terminal user interfaces based on ncurses | https://invisible-island.net/ncurses/ |
| **ncurses-utils** | 6.6.20260307+really6.5.20250830 | Tools for working with terminals | https://invisible-island.net/ncurses/ |
...
| **ne** | 3.3.4-2 | Easy-to-use and powerful text editor | https://ne.di.unimi.it/ |
| **nelua** | 2024.01.13-1 | Minimal, efficient, statically-typed and meta-programmable systems programming language | https://nelua.io |
| **neocmakelsp** | 0.10.2 | a cmake lsp based on tower-lsp and treesitter | https://neocmakelsp.github.io/ |
...
| **neovim-nightly** | 0.13.0~dev-141+gc4b592a6d0-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **netcat-openbsd** | 1.234-2-0 | TCP/IP swiss army knife. OpenBSD variant. | https://packages.debian.org/sid/netcat-openbsd |
| **netcdf-c** | 4.10.0 | NetCDF is a set of software libraries and self-describing, machine-independent data formats that support the creation, access, and sharing of array-oriented scientific data | https://www.unidata.ucar.edu/software/netcdf/ |
| **netcdf-c-static** | 4.10.0 | Static libraries for netcdf-c | https://www.unidata.ucar.edu/software/netcdf/ |
...
| **netstandard-targeting-pack-2.1-8.0** | 8.0.25 | NETStandard.Library 2.1 Targeting Pack (.NET 8.0) | https://dotnet.microsoft.com/en-us/ |
| **netstandard-targeting-pack-2.1-9.0** | 9.0.14 | NETStandard.Library 2.1 Targeting Pack (.NET 9.0) | https://dotnet.microsoft.com/en-us/ |
...
| **nginx** | 1.29.8 | Lightweight HTTP server | https://www.nginx.org |
...
| **nodejs** | 25.8.2 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
| **nodejs-lts** | 24.14.1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **npm** | 11.12.1 | The package manager for JavaScript | https://docs.npmjs.com/cli/ |
...
| **nushell** | 0.111.0 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **ollama** | 0.20.5 | Get up and running with large language models | https://ollama.com/ |
| **ollama-backend-vulkan** | 0.20.5 | Vulkan Backend for Ollama | https://ollama.com/ |
...
| **oniguruma** | 6.9.10-1 | Regular expressions library | https://github.com/kkos/oniguruma |
| **oniguruma-static** | 6.9.10-1 | Static libraries for oniguruma | https://github.com/kkos/oniguruma |
| **onnxruntime** | 1.24.4 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **openjdk-17** | 17.0.18 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-17-source** | 17.0.18 | Source files for openjdk-17 | https://openjdk.java.net |
| **openjdk-17-x** | 17.0.18 | Portion of openjdk-17 requiring X11 functionality | https://openjdk.java.net |
| **openjdk-21** | 21.0.10 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-21-source** | 21.0.10 | Source files for openjdk-21 | https://openjdk.java.net |
| **openjdk-21-x** | 21.0.10 | Portion of openjdk-21 requiring X11 functionality | https://openjdk.java.net |
| **openjdk-25** | 25.0.2 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-25-source** | 25.0.2 | Source files for openjdk-25 | https://openjdk.java.net |
| **openjdk-25-x** | 25.0.2 | Portion of openjdk-25 requiring X11 functionality | https://openjdk.java.net |
...
| **openldap** | 2.6.13 | OpenLDAP server | https://openldap.org |
| **openldap-static** | 2.6.13 | Static libraries for openldap | https://openldap.org |
| **openlist** | 4.2.1 | A file list program that supports multiple storage | https://oplist.org/ |
...
| **openssh** | 10.3p1 | Secure shell for logging into a remote machine | https://www.openssh.com/ |
| **openssh-sftp-server** | 10.3p1 | OpenSSH SFTP server subsystem | https://www.openssh.com/ |
...
| **openxr** | 1.1.58 | Open standard that provides a common set of APIs for developing XR applications | https://www.khronos.org/openxr/ |
...
| **orbiton** | 2.73.1 | Small, fast and limited text editor | https://roboticoverlords.org/orbiton/ |
...
| **oxfmt** | 1.59.0 | Oxc JavaScript formatter | https://oxc.rs/ |
| **oxlint** | 1.59.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **pacman** | 7.1.0-2 | A library-based package manager with dependency support | https://archlinux.org/pacman/ |
...
| **parallel** | 20260322 | GNU Parallel is a shell tool for executing jobs in parallel using one or more machines | https://www.gnu.org/software/parallel/ |
...
| **parted-static** | 3.6-1 | Static libraries for parted | https://www.gnu.org/software/parted/ |
...
| **passphrase2pgp** | 1.3.0-3 | Generate EdDSA/cv25519 private key in GnuPG/SSH format reproducibly per hash of user given passphrase | https://github.com/skeeto/passphrase2pgp |
| **pastebinit** | 1.5.1-3 | Command-line pastebin client | https://launchpad.net/pastebinit |
| **pastel** | 0.12.0 | A command-line tool to generate, analyze, convert and manipulate colors | https://github.com/sharkdp/pastel |
| **patch** | 2.8-1 | GNU patch which applies diff files to create patched files | https://savannah.gnu.org/projects/patch/ |
| **patchelf** | 0.18.0-1 | Utility to modify the dynamic linker and RPATH of ELF executables | https://nixos.org/patchelf.html |
...
| **pcaudiolib-static** | 1.3-1 | Static libraries for pcaudiolib | https://github.com/espeak-ng/pcaudiolib |
| **pcre** | 8.45-2 | Library implementing regular expression pattern matching using the same syntax and semantics as Perl 5 | https://www.pcre.org |
| **pcre-static** | 8.45-2 | Static libraries for pcre | https://www.pcre.org |
| **pcre2** | 10.47 | Perl 5 compatible regular expression library | https://pcre2project.github.io/pcre2/ |
...
| **php-apache-ldap** | 8.5.1 | LDAP module for PHP/Apache | https://php.net |
| **php-apache-pgsql** | 8.5.1 | PostgreSQL modules for PHP/Apache | https://php.net |
| **php-apache-sodium** | 8.5.1 | Sodium module for PHP/Apache | https://php.net |
| **php-apcu** | 5.1.28 | APCu - APC User Cache | http://php.net/apcu |
| **php-fpm** | 8.5.1 | FastCGI Process Manager for PHP | https://php.net |
| **php-gd** | 8.5.1 | gd module for PHP | https://php.net |
| **php-imagick** | 3.8.1-1 | The Imagick PHP extension | https://github.com/Imagick/imagick |
| **php-ldap** | 8.5.1 | LDAP module for PHP | https://php.net |
| **php-pgsql** | 8.5.1 | PostgreSQL modules for PHP | https://php.net |
...
| **php-zephir-parser** | 2.0.0 | The Zephir Parser delivered as a C extension for the PHP language | https://github.com/phalcon/php-zephir-parser |
...
| **pikiwidb** | 3.5.6-1 | Redis-Compatible database developed by Qihoo's infrastructure team | https://github.com/OpenAtomFoundation/pikiwidb |
| **pikiwidb-static** | 3.5.6-1 | Static libraries for pikiwidb | https://github.com/OpenAtomFoundation/pikiwidb |
| **pinentry** | 1.3.2-2 | Dialog allowing secure password entry | https://www.gnupg.org/related_software/pinentry/index.html |
| **pingme** | 0.2.7 | A small utility which can be called from anywhere to send a message with particular information | https://github.com/kha7iq/pingme |
| **pipebuffer** | 0.0.git20211120-1 | Arbitrary-sized in-memory buffer between pipelined programs (non-blocking mbuffer analogue for pipeline) | https://github.com/tfenne/pipebuffer |
| **pipes.sh** | 2018.04.22-1 | Animated pipes terminal screensaver | https://github.com/pipeseroni/pipes.sh |
| **pipewire** | 1.4.9-1 | A server and user space API to deal with multimedia pipelines | https://pipewire.org/ |
...
| **plantuml** | 1.2026.2 | Draws UML diagrams, using a simple and human readable text description | https://plantuml.com/ |
...
| **plutovg** | 1.3.2 | Tiny 2D vector graphics library in C | https://github.com/sammycage/plutovg |
...
| **pocketbase** | 0.36.9 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **povray** | 3.8.0-beta.2-18 | The Persistence of Vision Raytracer | https://www.povray.org/ |
| **povray-data** | 3.8.0-beta.2-18 | Platform-independent data for povray | https://www.povray.org/ |
...
| **pybind11** | 3.0.3 | A lightweight header-only library that exposes C++ types in Python and vice versa | https://pybind11.readthedocs.io/ |
...
| **pypy3** | 7.3.21 | A fast, compliant alternative implementation of Python 3 | https://pypy.org |
| **pypy3-tests** | 7.3.21 | Test files for PyPy 3 | https://pypy.org |
| **pypy3-tkinter** | 7.3.21 | Tkinter support for PyPy 3 | https://pypy.org |
| **pyrefly** | 0.60.2 | A fast type checker and language server for Python | https://github.com/facebook/pyrefly.git |
...
| **qemu-system-i386-headless** | 1:10.2.1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-m68k-headless** | 1:10.2.1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc-headless** | 1:10.2.1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc64-headless** | 1:10.2.1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv32-headless** | 1:10.2.1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv64-headless** | 1:10.2.1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless** | 1:10.2.1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-user-aarch64** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-arm** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-i386** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-m68k** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc64** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv32** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv64** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-x86-64** | 1:10.2.1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-utils** | 1:10.2.1 | A set of utilities for working with the QEMU emulators | https://www.qemu.org |
...
| **radare2** | 6.1.2 | UNIX-like reverse engineering framework and command-line toolset | https://www.radare.org/ |
...
| **railway-cli** | 4.37.2 | This is the command line interface for Railway | https://railway.app |
...
| **ravencoin** | 4.6.1-9 | A peer-to-peer blockchain, handling the efficient creation and transfer of assets from one party to another | https://ravencoin.org/ |
...
| **rdiff-backup** | 2.2.6-5 | A utility for local/remote mirroring and incremental backups | https://rdiff-backup.net |
| **rdircd** | 2023.02.07-3 | A daemon that allows using a personal Discord account through an IRC client | https://github.com/mk-fg/reliable-discord-client-irc-daemon |
| **rdrview** | 1:0.1.5-1 | Command line tool to extract the main content from a webpage | https://github.com/eafer/rdrview |
| **re2c** | 4.5.1 | Lexer generator for C, C++ and Go. | https://re2c.org/ |
...
| **recoll** | 1.43.14 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.43.14 | Python interface for Recoll | https://www.recoll.org/ |
...
| **rizin** | 0.8.2-1 | UNIX-like reverse engineering framework and command-line toolset. | https://rizin.re |
| **rlwrap** | 0.48 | Wrapper using readline to enable editing of keyboard input for commands | https://github.com/hanslub42/rlwrap |
| **rmpc** | 0.11.0 | A configurable TUI MPD client with album art support | https://mierak.github.io/rmpc/ |
| **rnr** | 0.5.1 | Batch rename files and directories using regular expression (rust) | https://github.com/ismaelgv/rnr |
| **robin-map** | 1.4.1 | C++ implementation of a fast hash map and hash set using robin hood hashing | https://github.com/Tessil/robin-map/ |
| **robotfindskitten** | 2022.05.21-1 | A very fun adventure game for robots and humans | https://github.com/noncombatant/robotfindskitten |
| **root-repo** | 2.4-2 | Package repository containing programs for rooted devices | https://github.com/termux/termux-root-packages |
...
| **ruff** | 0.15.10 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **samurai** | 1.2-2 | ninja-compatible build tool written in C | https://github.com/michaelforney/samurai |
...
| **sing-box** | 1.13.7 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **slashtime** | 2023.01.04-1 | A small program which displays the time in various places | https://github.com/istathar/slashtime |
| **sleuthkit** | 4.14.0-1 | The Sleuth Kit® (TSK) is a library for digital forensics tools.  | https://sleuthkit.org/ |
| **sleuthkit-static** | 4.14.0-1 | Static libraries for sleuthkit | https://sleuthkit.org/ |
...
| **solidity** | 0.8.34 | An Ethereum smart contract-oriented language | https://www.soliditylang.org/ |
| **sops** | 3.12.2 | Simple and flexible tool for managing secrets | https://github.com/getsops/sops |
...
| **spirv-llvm-translator** | 21.1.6 | SPIR-V LLVM Translator | https://github.com/KhronosGroup/SPIRV-LLVM-Translator |
...
| **sqlite** | 3.53.0 | Command line shell for SQLite | https://www.sqlite.org |
...
| **sslscan** | 2.2.2 | Utility to discover supported cipher suites on SSL/TLS enabled servers | https://github.com/rbsec/sslscan |
...
| **step-cli** | 0.30.2 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **suitesparse** | 2:7.12.2 | A Suite of Sparse matrix packages. | https://github.com/DrTimothyAldenDavis/SuiteSparse |
| **suitesparse-static** | 2:7.12.2 | Static libraries for suitesparse | https://github.com/DrTimothyAldenDavis/SuiteSparse |
| **sun** | 1.0.0-3 | A very simple note taking cli app | https://stand-up-notes.org |
| **sundials** | 2:7.7.0 | SUite of Nonlinear and DIfferential/ALgebraic equation Solvers. | https://computing.llnl.gov/projects/sundials |
| **sundials-static** | 2:7.7.0 | Static libraries for sundials | https://computing.llnl.gov/projects/sundials |
| **supercollider** | 3.14.1 | A platform for audio synthesis and algorithmic composition | http://supercollider.github.io/ |
...
| **swi-prolog** | 10.1.5 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **syncthing** | 2.0.16 | Decentralized file synchronization | https://syncthing.net/ |
...
| **taglib** | 2.2.1 | A Library for reading and editing the meta-data of several popular audio formats. | http://taglib.github.io/ |
| **taplo** | 0.10.0-1 | A TOML LSP and toolkit | https://taplo.tamasfe.dev/ |
...
| **teleport-tsh** | 18.7.2 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **termplay** | 2.0.6-1 | Plays an image/video in your terminal | https://gitlab.com/jD91mZM2/termplay |
...
| **termux-gui-bash** | 0.1.2-1 | A bash library for Termux:GUI | https://github.com/tareksander/termux-gui-bash |
| **termux-gui-c** | 0.1.3-6 | A C library for the Termux:GUI plugin | https://github.com/tareksander/termux-gui-c-bindings |
...
| **tig** | 2.6.0 | Ncurses-based text-mode interface for git | https://jonas.github.io/tig/ |
...
| **tinymist** | 0.14.10 | An integrated language service for Typst | https://myriad-dreamin.github.io/tinymist |
...
| **topgrade** | 17.3.0 | Upgrade all the things | https://github.com/topgrade-rs/topgrade/ |
...
| **tree-sitter-java** | 0.23.5-1 | Java grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-java |
| **tree-sitter-javascript** | 0.25.0-1 | JavaScript grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-javascript |
| **tree-sitter-json** | 0.24.8-1 | JSON grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-json |
| **tree-sitter-latex** | 0.6.0-1 | LaTeX grammar for tree-sitter | https://github.com/latex-lsp/tree-sitter-latex |
| **tree-sitter-lua** | 0.5.0-1 | Lua grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-lua |
| **tree-sitter-markdown** | 0.5.3-1 | Markdown grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
| **tree-sitter-parsers** | 0.26 | A metapackage that provides commonly used treesitter parsers | https://github.com/termux/termux-packages |
| **tree-sitter-python** | 0.25.0-1 | Python grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-python |
| **tree-sitter-query** | 0.8.0-2 | TS query grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-query |
| **tree-sitter-regex** | 0.25.0-1 | RegEx grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-regex |
| **tree-sitter-rust** | 0.24.2-1 | Rust grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-rust |
| **tree-sitter-sql** | 0.3.11-1 | SQL grammar for tree-sitter | https://github.com/derekstride/tree-sitter-sql |
| **tree-sitter-static** | 0.25.10-2 | Static libraries for tree-sitter | https://tree-sitter.github.io/ |
| **tree-sitter-toml** | 0.7.0-1 | TOML grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-toml |
| **tree-sitter-vim** | 0.8.1-1 | Vimscript grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-vim |
| **tree-sitter-vimdoc** | 4.1.0-2 | Tree-sitter parser for Vim help files | https://github.com/neovim/tree-sitter-vimdoc |
| **tree-sitter-xml** | 0.7.0-1 | XML grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-xml |
| **tree-sitter-yaml** | 0.7.2-1 | YAML grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-yaml |
...
| **trzsz-go** | 1.2.0 | A simple file transfer tools, similar to lrzsz ( rz / sz ) | https://trzsz.github.io/ |
| **trzsz-ssh** | 0.1.24 | An openssh client alternative | https://trzsz.github.io/ssh |
| **tsduck-java** | 3.43.4549-1 | Java bindings for TSDuck | https://tsduck.io/ |
| **tsduck-plugins** | 3.43.4549-1 | Plugins for TSDuck | https://tsduck.io/ |
| **tsduck-python** | 3.43.4549-1 | Python bindings for TSDuck | https://tsduck.io/ |
| **tsduck-tools** | 3.43.4549-1 | Command line tools for TSDuck | https://tsduck.io/ |
| **tsocks** | 1.8beta5-5 | transparent network access through a SOCKS 4 or 5 proxy | http://tsocks.sf.net |
...
| **ttf-jetbrains-mono** | 2.304 | A free and open-source typeface for developers | https://www.jetbrains.com/lp/mono/ |
| **ttf-nerd-fonts-symbols** | 3.4.0 | Symbols-only font containing the Nerd Font icons | https://www.nerdfonts.com/ |
| **tty-clock** | 2.3-2 | Simple terminal clock | https://github.com/xorg62/tty-clock |
| **tty-solitaire** | 1.4.1-1 | Klondike solitaire game | https://github.com/mpereira/tty-solitaire |
| **ttyc** | 0.4-4 | ttyd protocol client | https://github.com/Depau/ttyc |
| **ttyd** | 1.7.7-3 | Command-line tool for sharing terminal over the web | https://tsl0922.github.io/ttyd/ |
| **ttyper** | 1.6.0-1 | Terminal-based typing test | https://github.com/max-niederman/ttyper |
| **ttyplot** | 1.7.4 | A realtime plotting utility for terminal with data input from stdin | https://github.com/tenox7/ttyplot |
...
| **turbo** | 2.9.6 | High-performance build system for JS/TS | https://turbo.build/ |
| **turbopack** | 16.2.3 | Rust-based incremental compilation engine and bundler for Next.js | https://nextjs.org/ |
...
| **ugrep** | 7.6.0 | A faster, user-friendly and compatible grep replacement | https://github.com/Genivia/ugrep |
...
| **util-linux** | 2.41.3 | Miscellaneous system utilities | https://en.wikipedia.org/wiki/Util-linux |
...
| **uv** | 0.11.6 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vde2-static** | 2.3.3-5 | Static libraries for vde2 | https://github.com/virtualsquare/vde-2 |
| **vegeta** | 12.13.0 | HTTP load testing tool | https://github.com/tsenart/vegeta |
| **vera** | 1.3.0-9 | A programmable tool for verification, analysis and transformation of C++ source code | https://bitbucket.org/verateam/vera |
| **vgmstream** | 2083-1 | A library for playback of various streamed audio formats used in video games | https://github.com/vgmstream/vgmstream |
...
| **vim** | 9.2.0300 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **vtm** | 2026.04.10 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-loader-generic** | 1.4.349 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.349 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.349 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **wakatime-cli** | 2.2.0 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **wasmedge** | 0.16.1 | A lightweight, high-performance, and extensible WebAssembly runtime | https://wasmedge.org/ |
...
| **webtunnel** | 0.0.3 | Pluggable Transport based on HTTP Upgrade(HTTPT) | https://torproject.org/ |
| **weechat** | 4.7.1-2 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.7.1-2 | WeeChat Lua Plugin | https://weechat.org/ |
...
| **weechat-perl-plugin** | 4.7.1-2 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.7.1-2 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.7.1-2 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **wireproxy** | 1.1.2 | Wireguard client that exposes itself as a socks5 proxy | https://github.com/pufferffish/wireproxy |
...
| **wordgrinder** | 0.8-1 | A Unicode-aware character cell word processor | http://cowlark.com/wordgrinder/ |
...
| **wtfutil** | 0.49.0 | The personal information dashboard for your terminal | https://wtfutil.com/ |
...
| **xorriso** | 1:1.5.8 | Tool for creating ISO files | https://www.gnu.org/software/xorriso |
...
| **xxd** | 9.2.0300 | Hexdump utility from vim | https://www.vim.org |
...
| **zsync** | 0.6.3-1 | A file transfer program to download files from remote web servers | https://zsync.moria.org.uk/ |
